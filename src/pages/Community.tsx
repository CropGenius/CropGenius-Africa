  ...
  const [experts, setExperts] = useState<Expert[]>([
    {
      ...
      badges: ["PhD Plant Pathology", "Research Award Winner", "300+ Solutions"],
      rating: 4.9,
      answers: 328,
  ...
  const [badges, setBadges] = useState<Badge[]>([
    {
      id: 1,
      name: "Soil Master",
      description: "Awarded for exceptional knowledge in soil health and management",
      icon: Trophy,
      category: 'expertise',
      level: 'gold',
    ...
    },
    {
      ...
      description: "Awarded for helping other farmers through consistent high-quality contributions",
      icon: Users,
    ...
    },
    {
      id: 3,
      name: "Crop Doctor",
      description: "Awarded for expertise in identifying and treating crop diseases",
      icon: Microscope,
      category: 'expertise',
      level: 'bronze',
  ...
  const submitQuestion = () => {
    ...
    setTimeout(() => {
      toast.info("AI Assistant Found Something", {
        description: "Based on your question, we found 3 similar issues with solutions",
      });
    }, 3000);
  };
  ...
  const followExpert = (expertId: number) => {
    ...
    if (isNowFollowing) {
      toast.success(`Following ${expert?.name}`, {
        description: "You'll be notified when they answer questions in your areas of interest",
      });
    } else {
      toast.info(`Unfollowed ${expert?.name}`, {
        description: "You'll no longer receive notifications about their activity",
      });
    }
  };
    ...
    <div className="p-5 pb-20 animate-fade-in">
        ...
        <div className="mb-5">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-crop-green-700">AI Expert Community</h1>
              <p className="text-gray-600">Africa's largest AI-powered farming knowledge network</p>
            </div>
            <Button
              onClick={askQuestion}
              ...
              <div className="space-y-3">
                <div className="bg-white p-3 rounded-lg border border-gray-100">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-800">Based on your crops: Soil Health Fundamentals</h4>
                      <p className="text-sm text-gray-600 mb-2">This course will help you improve your maize yields through better soil management</p>
                      <Button size="sm" variant="outline" className="h-7 text-xs" onClick={() => enrollInTraining(2)}>
                        View Course
                      </Button>
                    </div>
                  </div>
                ...
                <div className="bg-white p-3 rounded-lg border border-gray-100">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-800">Expert match: Dr. James Mwangi</h4>
                      <p className="text-sm text-gray-600 mb-2">Crop disease specialist can help with your tomato plant issues</p>
                      <Button size="sm" variant="outline" className="h-7 text-xs" onClick={() => followExpert(1)}>
                        Connect
                      </Button>
                    </div>
                  </div>
                ...
                <div className="bg-white p-3 rounded-lg border border-gray-100">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-800">You're 65% to earning the Soil Master badge!</h4>
                      <p className="text-sm text-gray-600 mb-2">Answer more soil-related questions to unlock this achievement</p>
        ...
        {askingQuestion && (
          <Card className="mb-5 border-amber-200 animate-fade-in">
            <CardHeader>
              <CardTitle className="text-lg">Ask Your Farming Question</CardTitle>
              <CardDescription>Our AI will immediately match you with experts and existing answers</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardFooter className="flex justify-end space-x-2">
              ...
              <Button className="bg-crop-green-600 hover:bg-crop-green-700 text-white" onClick={submitQuestion}>
                Post Question
              </Button>
            </CardFooter>
          </Card>
        ...
        >
              ...
              {filteredQuestions.length === 0 ? (
                <Card className="bg-gray-50">
                  <CardContent className="pt-6 text-center">
                    ...
                    <Button className="mt-4 bg-crop-green-600 hover:bg-crop-green-700 text-white" onClick={askQuestion}>
                      Ask a New Question
                    </Button>
                  </CardContent>
                </Card>
                ...
                filteredQuestions.map(question => (
                  <Card key={question.id} className={question.isFeatured ? 'border-amber-300 bg-amber-50' : ''}>
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between">
                        <div className="flex-grow">
                          <div className="flex items-center">
                            <h3 className="font-semibold text-lg mr-2">{question.title}</h3>
                          ...
                          <div className="mt-2">
                            <p className="text-gray-700">{question.body.length > 150 ? `${question.body.substring(0, 150)}...` : question.body}</p>
                          </div>
                          
                          <div className="mt-3 flex flex-wrap gap-1">
                            <Badge className="bg-gray-100 text-gray-800 border-0">{question.category}</Badge>
                          ...
                          {question.answers.length > 0 && question.status === 'solved' && (
                              ...
                              <div className="flex items-start">
                                ...
                                <div className="ml-2">
                                  <div className="text-sm font-medium text-gray-900 flex items-center">
                                    Accepted Answer from {question.answers[0].author}
                ...
                <Card key={resource.id} className="overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between">
                      <div>
                        <div className="flex items-center">
                          {resource.type === 'course' && <Book className="h-4 w-4 text-crop-green-600 mr-1" />}
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                      <div className="md:w-1/4 flex flex-col items-center text-center">
                        ...
                        <div className="mt-1 flex items-center justify-center">
                          ...
                          <span className="mx-1">•</span>
                          <span className="text-sm text-gray-600">{expert.answers} answers</span>
                        </div>
                      ...
                      <div className="md:w-3/4">
                        <div className="mb-3">
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            <span className="font-medium">Availability:</span> {expert.availability}
                          </p>
                        </div>
                        
                        <div className="mt-4">
                          <p className="text-sm font-medium mb-2">Expert Badges:</p>
                          <div className="flex flex-wrap gap-2">
                            {expert.badges.map((badge, index) => (
                              <Badge key={index} className="bg-crop-green-100 text-crop-green-700 border-0 px-3 py-1">
                                {badge}
                              </Badge>
                            ))}
                          </div>
          ...
          <TabsContent value="achievements" className="mt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {badges.map(badge => (
                <Card key={badge.id} className={`overflow-hidden ${badge.isEarned ? 'border-amber-300' : ''}`}>
                  <CardContent className="p-4">
                    <div className="flex flex-col items-center text-center">
                      ...
                      <div className="mt-2 flex items-center justify-center">
                        ...
                        <span className="mx-1">•</span>
                        <span className="text-xs text-gray-500">{badge.earnedBy} farmers earned</span>
                      </div>
                      ...
                      <div className="mt-3 w-full">
                        {badge.isEarned ? (
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-600 mt-1">{badge.requirements}</p>
                          </div>
                        ) : (
                          <p className="text-xs text-gray-600 mt-1">{badge.requirements}</p>
                        )}
