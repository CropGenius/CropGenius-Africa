...
import { analyzeFieldEnhanced, type EnhancedFieldAnalysis, type GeoLocation } from '@/intelligence/enhancedFieldIntelligence';
...
const SatelliteImageryDisplay: React.FC<SatelliteImageryDisplayProps> = ({ 
  ...
  const handleFieldAnalysis = async () => {
    ...
    try {
      ...
      const analysis = await analyzeFieldEnhanced(coordinates, user?.id);
            ...
            <Card className="relative aspect-video bg-gradient-to-br from-gray-900 to-gray-800 border-cyan-400/20 overflow-hidden">
              ...
              <div className="absolute inset-0">
                <div className={`w-full h-full transition-all duration-500 ${
                  viewMode === 'ndvi' ? 'bg-gradient-to-br from-red-500 via-yellow-400 to-green-400' :
          ...
          >
            <Card className="p-8 bg-gradient-to-br from-cyan-500/10 to-purple-500/10 border-cyan-400/20">
              <div className="flex items-center justify-between mb-6">
                ...
                <Button className="bg-cyan-400 text-black font-semibold">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className={`font-bold ${
                        analysisData.moistureStress === 'low' ? 'text-green-400' :
